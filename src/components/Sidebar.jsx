  ...
  return (
    <div >
      <Link to="/dashboard">
        <img
          src={logo}
          className="mx-auto bg-white rounded-xl my-8 h-20"
          width={150}
          alt="Float UI logo"
        />
      </Link>
      ...
      <Link to={"/"}>
        <button class="mt-8 mx-auto group flex items-center justify-start w-11 h-11 bg-red-600 rounded-full cursor-pointer relative overflow-hidden transition-all duration-200 shadow-lg hover:w-44 hover:rounded-lg active:translate-x-1 active:translate-y-1">
          ...
          <div class="absolute right-3 transform translate-x-full opacity-0 text-white text-lg font-semibold transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
            Deconnexion
          </div>
        </button>
      </Link>
